(function ($) {
    ...
    // Nắp lồng
    var cage_lid = [
        { id: 1026, material: "Vải", time: 8, base_money: 300000, wage: 80000 },
        { id: 1027, material: "Gỗ", time: 24, base_money: 400000, wage: 150000 },
        { id: 1028, material: "Nhựa", time: 12, base_money: 200000, wage: 100000 },
    ];
    // Nan lồng
    var cage_body = [
    ...
    var formData = {
        ...
        cage_body: { id: 1016, material: "Nhựa", time: 1 / 60, base_money: 3000, wage: 0 },
